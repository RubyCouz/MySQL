...
SELECT `language`, `version` FROM `Languages` WHERE `id` = '3' OR `id` = '5' OR `id` = '7'; -- = WHERE `id` IN (3,5,7)
...
SELECT * FROM `Languages` ORDER BY `language`; -- ASC = ordre alphabétique, DESC = ordre inverse
